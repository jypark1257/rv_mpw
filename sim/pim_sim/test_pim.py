...
async def core_bench(dut):
    ...
    dut.pim_0.i_result_in0.value = random.randint(0, 2**8192)
    dut.pim_0.i_result_in1.value = random.randint(0, 2**8192)
    dut.pim_0.i_result_in2.value = random.randint(0, 2**8192)
    dut.pim_0.i_result_in3.value = random.randint(0, 2**8192)
    ...
    for i in range (0, 448):
        dut.buf_0.buf_sram.mem[i].value = random.randint(0, 2**512)
    await RisingEdge(dut.i_clk)
    await Timer(1, units="ns")
    
    print("0: ", dut.buf_0.buf_sram.mem[i].value)
    #for i in range (0, 448):
    #    dut.buf_0.buf_sram.mem[i].value = random.randint(0, 2**512)
    print("1: ", dut.buf_0.buf_sram.mem[i].value)
    await RisingEdge(dut.i_clk)
    
    print("2: ", dut.buf_0.buf_sram.mem[i].value)
    ...
    print("3: ", dut.buf_0.buf_sram.mem[i].value)
