...
//      Test Muxes                  Off
//
//      Creation Date:  Mon Jun 24 18:38:54 2024
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module sram_7168w_32b (Q, CLK, CEN, WEN, A, D, EMA, GWEN, RETN, VSSE, VDDPE, VDDCE);
`else
module sram_7168w_32b (Q, CLK, CEN, WEN, A, D, EMA, GWEN, RETN);
`endif

  parameter BITS = 32;
  parameter WORDS = 7168;
  parameter MUX = 16;
  parameter MEM_WIDTH = 512; // redun block size 8, 256 on left, 256 on right
  parameter MEM_HEIGHT = 448;
  parameter WP_SIZE = 8 ;
...
`endif
  ...
  reg NOT_A0, NOT_A1, NOT_A10, NOT_A11, NOT_A12, NOT_A2, NOT_A3, NOT_A4, NOT_A5, NOT_A6;
  reg NOT_A7, NOT_A8, NOT_A9, NOT_CEN, NOT_CLK_MINH, NOT_CLK_MINL, NOT_CLK_PER, NOT_D0;
  reg NOT_D1, NOT_D10, NOT_D11, NOT_D12, NOT_D13, NOT_D14, NOT_D15, NOT_D16, NOT_D17;
  reg NOT_D18, NOT_D19, NOT_D2, NOT_D20, NOT_D21, NOT_D22, NOT_D23, NOT_D24, NOT_D25;
  reg NOT_D26, NOT_D27, NOT_D28, NOT_D29, NOT_D3, NOT_D30, NOT_D31, NOT_D4, NOT_D5;
  reg NOT_D6, NOT_D7, NOT_D8, NOT_D9, NOT_EMA0, NOT_EMA1, NOT_EMA2, NOT_GWEN, NOT_RETN;
  reg NOT_WEN0, NOT_WEN1, NOT_WEN2, NOT_WEN3;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
 ...
 wire  CLK_;
  ...
  buf B81(D_[30], D[30]);
  buf B82(D_[31], D[31]);
  buf B83(EMA_[0], EMA[0]);
  buf B84(EMA_[1], EMA[1]);
  buf B85(EMA_[2], EMA[2]);
  buf B86(GWEN_, GWEN);
  buf B87(RETN_, RETN);
...
`endif
  ...
  specify
      ...
      $setuphold(posedge CLK &&& flag, posedge A[12], 1.000, 0.500, NOT_A12);
      $setuphold(posedge CLK &&& flag, negedge A[12], 1.000, 0.500, NOT_A12);
